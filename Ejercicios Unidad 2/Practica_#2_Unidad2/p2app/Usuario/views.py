...
def detalleUsuario(req, id) :
    ...
    return render(req, 'detalleUs.html', {'usuario': usuario});
...
def nuevoUsuario(req) :
    if req.method == "POST":
        ...
        return render(req, 'agregarUs.html', {'formaUsuario': formaUsuario})
...
def editarUsuario(req, id):
    ...
    if req.method == "POST":
        ...
        return render(req, 'editarUs.html', {'formaUsuario': formaUsuario})
