...
def detalleCategoria(req, id) :
    ...
    return render(req, 'detalleCat.html', {'categoria': categoria});
...
def nuevoCategoria(req) :
    if req.method == "POST":
        ...
        return render(req, 'agregarCat.html', {'formaCategoria': formaCategoria})
...
def editarCategoria(req, id):
    ...
    if req.method == "POST":
        ...
        return render(req, 'editarCat.html', {'formaCategoria': formaCategoria})
